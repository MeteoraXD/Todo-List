...
const InCompletedIcon:React.FunctionComponent = () => {
  return (
    <svg  height="20px" width= "20px" viewBox="0 0 1024 1024" className="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" fill="#000000"
         >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path d="M548.6 365.7h-73.2v161.4l120.5 120.5 51.7-51.7-99-99z" fill="#000000"
